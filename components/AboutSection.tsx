    ...
    return (
        <section className="relative w-full overflow-hidden">
            <div className="pointer-events-none absolute inset-0 -z-10">
                <div
                    className="absolute -top-32 left-1/2 h-[420px] w-[420px] -translate-x-1/2 rounded-full bg-[radial-gradient(circle_at_center,rgba(205,165,112,0.22),rgba(227,221,211,0.04)_60%,transparent_72%)] blur-3xl"/>
                <div
                    className="absolute right-[-120px] top-24 h-[360px] w-[360px] rounded-full bg-[radial-gradient(circle_at_center,rgba(45,106,91,0.16),rgba(227,221,211,0.03)_55%,transparent_70%)] blur-[120px]"/>
                <div
                    className="absolute inset-0 bg-[linear-gradient(transparent_0%,rgba(188,173,153,0.18)_46%,rgba(221,211,198,0.54)_100%)]"/>
            </div>
                ...
                <span className="eyebrow">
                  ...
                  About
                                ...
                                <div className="space-y-4">
                                    <TextScrollWordReveal text={"Building useful software for complex environments."}/>
                ...
                <div className="page-container pb-20 sm:pb-24">
                    ...
                    {tag}
                        ...
                        <div className="surface-panel p-3 sm:p-4">
                            <div
                                className="aspect-video w-full overflow-hidden rounded-[1.35rem] border border-black/10 bg-[#e8dece] shadow-[0_12px_30px_rgba(78,60,42,0.12)]">
                                <video
