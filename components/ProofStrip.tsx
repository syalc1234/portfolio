  ...
  return (
    <section className="relative left-1/2 -mx-[50vw] w-screen bg-[#05070a] text-white pt-5 pb-10">
      <div className="mx-auto w-full max-w-6xl px-6 sm:px-10">
        <div className="mt-8 rounded-2xl border border-white/10 bg-white/5 px-4 py-4 shadow-[0_18px_60px_rgba(0,0,0,0.35)] backdrop-blur-xl sm:mt-10 sm:px-6 sm:py-5">
